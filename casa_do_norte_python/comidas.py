import tkinter as tk  # Importa tkinter base para construção da interface
from tkinter import ttk, messagebox  # Importa widgets temáticos e caixas de mensagem
...
def showcomidas(app):
    ...
    # Limpa toda a interface da janela principal para mostrar tela de comidas
