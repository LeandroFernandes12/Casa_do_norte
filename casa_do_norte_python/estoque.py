...
from tkinter import ttk, messagebox  # Importa widgets temáticos e caixa de mensagens para alertas.
import datetime  # Importa o módulo datetime para manipulação de datas.

from db import getconnection  # Importa função para conectar ao banco de dados.
from utils import centralizarjanela  # Importa função para centralizar janelas na tela.

def showgestaoestoque(app):
    """Exibe a tela de gestão de estoque."""

    # Limpa todos os widgets da janela principal antes de exibir a tela de estoque.
