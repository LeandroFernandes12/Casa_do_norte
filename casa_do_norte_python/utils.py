import tkinter as tk  # Importa o módulo do tkinter para recursos extras de interface.

from db import getconnection  # Importa o método para abrir conexões com o banco de dados.
